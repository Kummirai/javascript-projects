      ...
      data.meals.forEach((recipe) => {
        ...
        saved.forEach((save) => {
          save.addEventListener("click", () => {
            ...
            const myMenu = data.meals.filter((menu) => menu.idMeal === id);
            ...
            let existingRecipe = myRecipes.find(
              (recipe) => recipe.id === saveRecipe.id
            );
        ...
        videos.forEach((button) => {
          button.addEventListener("click", () => {
            ...
            const myMenu = data.meals.filter((menu) => menu.idMeal === mealId);
        ...
        <div class="modal-details">
          ...
          <div class="ingredients">
            <ul>
             <li class=${item.strIngredient1 === "" ? "hidden" : ""}>${
                    item.strIngredient2
                  }</li>
              <li class=${item.strIngredient2 === "" ? "hidden" : ""}>${
                    item.strIngredient2
                  }</li>
              <li class=${item.strIngredient3 === "" ? "hidden" : ""}>${
                    item.strIngredient3
                  }</li>
              <li class=${item.strIngredient4 === "" ? "hidden" : ""}>${
                    item.strIngredient4
                  }</li>
              <li class=${item.strIngredient5 === "" ? "hidden" : ""}>${
                    item.strIngredient5
                  }</li>
              <li class=${item.strIngredient6 === "" ? "hidden" : ""}>${
                    item.strIngredient6
                  }</li>
              <li class=${item.strIngredient7 === "" ? "hidden" : ""}>${
                    item.strIngredient7
                  }</li>
              <li class=${item.strIngredient8 === "" ? "hidden" : ""}>${
                    item.strIngredient8
                  }</li>
              <li class=${item.strIngredient9 === "" ? "hidden" : ""}>${
                    item.strIngredient9
                  }</li>
              <li class=${item.strIngredient10 === "" ? "hidden" : ""}>${
                    item.strIngredient10
                  }</li>
              <li class=${item.strIngredient11 === "" ? "hidden" : ""}>${
                    item.strIngredient11
                  }</li>
              <li class=${item.strIngredient12 === "" ? "hidden" : ""}>${
                    item.strIngredient12
                  }</li>
              <li class=${item.strIngredient13 === "" ? "hidden" : ""}>${
                    item.strIngredient13
                  }</li>
              <li class=${item.strIngredient14 === "" ? "hidden" : ""}>${
                    item.strIngredient14
                  }</li>
              <li class=${item.strIngredient15 === "" ? "hidden" : ""}>${
                    item.strIngredient15
                  }</li>
              <li class=${item.strIngredient16 === "" ? "hidden" : ""}>${
                    item.strIngredient16
                  }</li>
              <li class=${item.strIngredient17 === "" ? "hidden" : ""}>${
                    item.strIngredient17
                  }</li>
              <li class=${item.strIngredient18 === "" ? "hidden" : ""}>${
                    item.strIngredient18
                  }</li>
              <li class=${item.strIngredient19 === "" ? "hidden" : ""}>${
          ...
          <div class="instructions">
            <ol>${instructions.map((inst) => `<li>${inst}</li>`)}</ol>
          </div>
        </div>
        `;
...
const homepageMenu = [
  ...
  },
  {
    ...
    desc: " Cheesy, layered, comforting",
    type: "Lunch",
  },
  {
    id: "4",
    title: "French Fries",
    img: "images/lasgna.png",
    desc: "Crispy, salty, addictive",
    type: "Lunch",
  },
];
